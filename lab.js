...
console.log("-----------")
console.log(totalPopulation(variables))
console.log("-----------")
//////////////////////////// PROBLEM 9 ////////////////////////////
...
let jeff = new Wizard('Jeff', 19, 'Fireball Frenzy')
jeff.castSpell()
...
let iPhone  = new Phone("Apple", "iPhone",256,"White", 700)
iPhone.sell()
...
//Code Here
let iPhone12  = new Phone("Apple", "iPhone",256,"White", 700)
let Galaxy  = new Phone("Samsung", "S21",256,"Black", 800)
let Pixel  = new Phone("Google", "Pixel",256,"White", 600)
